...
// Area Chart Example
var ctxMediaStatus = document.getElementById("myAreaChart4");
var identificacaoIlegivel = document.getElementById("identificacaoIlegivel").value.split(",").map(parseFloat);
var cpfDivergente = document.getElementById("cpfDivergente").value.split(",").map(parseFloat);
var identificacaoIncompleta = document.getElementById("identificacaoIncompleta").value.split(",").map(parseFloat);
var riscoDocumento = document.getElementById("riscoDocumento").value.split(",").map(parseFloat);
var reprovado = document.getElementById("reprovado").value.split(",").map(parseFloat);
var semRisco = document.getElementById("semRisco").value.split(",").map(parseFloat);
var identificacaoAusente = document.getElementById("identificacaoAusente").value.split(",").map(parseFloat);
var aprovado = document.getElementById("aprovado").value.split(",").map(parseFloat);
var labelspag = document.getElementById("mediaDataHora").value.split(",");

var myLineChart4 = new Chart(ctxMediaStatus, {
  type: 'line',
  data: {
    labels: labelspag,
    datasets: [{
     label: "IDENTIFICAÇÃO ILEGÍVEL: ",
      lineTension: 0.5,
      backgroundColor: "rgba(255, 255, 240, 0.01)",
      borderColor: "rgba(255, 144, 51, 1)",
      pointRadius: 1,
      ...
      pointHitRadius: 12,
      pointBorderWidth: 2,
      data: identificacaoIlegivel.map(parseFloat),
    },
    {
      label: "CPF DIVERGENTE DO DOCUMENTO: ",
      lineTension: 0.5,
      backgroundColor: "rgba(255, 255, 240, 0.01)",
      borderColor: "rgba(78, 115, 223, 1)",
      pointRadius: 1,
      ...
      pointHitRadius: 12,
      pointBorderWidth: 2,
      data: cpfDivergente.map(parseFloat),
    },
    {
      label: "IDENTIFICAÇÃO INCOMPLETO: ",
      lineTension: 0.5,
      backgroundColor: "rgba(255, 255, 240, 0.01)",
      borderColor: "rgba(28, 200, 138, 1)",
      pointRadius: 1,
      ...
      pointHitRadius: 12,
      pointBorderWidth: 2,
      data: identificacaoIncompleta.map(parseFloat),
    }, 
    {
      label: "RISCO NO DOCUMENTO: ",
      lineTension: 0.5,
      backgroundColor: "rgba(255, 255, 240, 0.01)",
      borderColor: "rgba(28, 200, 194, 1)",
      pointRadius: 1,
      ...
      pointHitRadius: 12,
      pointBorderWidth: 2,
      data: riscoDocumento.map(parseFloat),
    }, 
    {
      label: "REPROVADO: ",
      lineTension: 0.5,
      ...
      pointHitRadius: 12,
      pointBorderWidth: 2,
      data: reprovado.map(parseFloat),
    },
    {
      label: "SEM RISCO APARENTE: ",
      lineTension: 0.5,
      backgroundColor: "rgba(255, 255, 240, 0.01)",
      borderColor: "rgba(200, 186, 28, 1)",
      pointRadius: 1,
      ...
      pointHitRadius: 12,
      pointBorderWidth: 2,
      data: semRisco.map(parseFloat),
    },
    {
      label: "IDENTIFICAÇÃO AUSENTE: ",
      lineTension: 0.5,
      backgroundColor: "rgba(255, 255, 240, 0.01)",
      borderColor: "rgba(200, 186, 28, 1)",
      pointRadius: 1,
      ...
      pointHitRadius: 12,
      pointBorderWidth: 2,
      data: identificacaoAusente.map(parseFloat),
    },
    {
      label: "APROVADO: ",
      lineTension: 0.5,
