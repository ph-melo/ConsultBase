...
// Area Chart Example
var ctxClick = document.getElementById("myAreaChart");
    ...
    tooltips: {
      ...
      callbacks: {
        label: function(tooltipItem, chart) {
          ...
          return datasetLabel + 'Finalizados: ' + number_format(tooltipItem.yLabel);
        }
      }
    }
  }
...
// Area Chart Example
var ctxClickRecusados = document.getElementById("myAreaChart2");
...
var myLineChart2 = new Chart(ctxClickRecusados, {
  type: 'line',
  data: {
    labels: labelspag2,
    datasets: [{
