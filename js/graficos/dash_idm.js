...
var msgchart = document.getElementById("msgchart").value;
var msg = msgchart.split(",");
...
// Area Chart Example
var ctxDig = document.getElementById("myAreaChart3");
...
var myLineChart3 = new Chart(ctxDig, {
  type: 'line',
  data: {
    labels: labelspag3,
    datasets: [{
...
// Area Chart Example
var ctxDig = document.getElementById("myAreaChart4");
...
var myLineChart4 = new Chart(ctxDig, {
  type: 'line',
  data: {
    labels: labelspag4,
    datasets: [{
