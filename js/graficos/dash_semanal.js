    ...
    tooltips: {
      ...
      callbacks: {
        label: function(tooltipItem, chart) {
          ...
          return datasetLabel + 'Aprova\u00e7\u00f5es: ' + number_format(tooltipItem.yLabel);
        }
      }
    }
  }
...
// Area Chart Example
var ctxContrato = document.getElementById("myAreaChart4");
var modOferta = document.getElementById("modOferta").value.split(",");
var trocaOferta = document.getElementById("trocaOferta").value.split(",");
var habilitacao = document.getElementById("habilitacao").value.split(",");
var migracao = document.getElementById("migracao").value.split(",");
var portabilidade = document.getElementById("portabilidade").value.split(",");
var labelspag = document.getElementById("dataHora").value.split(",");

var myLineChart4 = new Chart(ctxContrato, {
  type: 'line',
  data: {
    labels: labelspag,
    datasets: [{
     label: "Modificação na Oferta: ",
      lineTension: 0.5,
