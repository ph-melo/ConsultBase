...
<%
    ...
    if(deslogar.equals("") &&  request.getSession().getAttribute("nomeSessao") != null && !request.getSession().getAttribute("nomeSessao").equals("")){
        ...
        response.sendRedirect("./home.jsp"); //sidebar_juri.jsp
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">ConsultBase</h1>
                                    </div>
                                    ...
                                    <div class="text-center">
										<a class="small" href="./adm_login.jsp">Acesso Administrativo</a>                                   
                                    </div>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Login e/ou senha inv�lidos</div>
