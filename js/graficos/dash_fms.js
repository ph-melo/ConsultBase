...
var cDRVozVivo2 = document.getElementById("cDRVozVivo2").value.split(",");
var cDRVozVivo2LDNLDI = document.getElementById("cDRVozVivo2LDNLDI").value.split(",");
var cDRGSMVoz = document.getElementById("cDRGSMVoz").value.split(",");
var cDRGSMSMSMMS = document.getElementById("cDRGSMSMSMMS").value.split(",");
var cDRGSMDados = document.getElementById("cDRGSMDados").value.split(",");
var cDRFixaVoz = document.getElementById("cDRFixaVoz").value.split(",");
var labelspag6 = document.getElementById("dataCDR").value.split(",");
